...
function crearUsuarioConTenant(email_1, password_1, tenantId_1) {
    return __awaiter(this, arguments, void 0, function (email, password, tenantId, isDemo) {
        var _a, data, error;
        if (isDemo === void 0) { isDemo = false; }
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, supabase.auth.admin.createUser({
                        email: email,
                        password: password,
                        user_metadata: {
                            tenant_id: tenantId,
